...
//  huangfeilong
//
//  Created by huangfeilong on 16/1/5.
//  Copyright © 2016年 huangfeilong. All rights reserved.
//
...
- (void)loadContentWithAdapter:(CellDataAdapter *)dataAdapter
                      delegate:(id <CustomCellDelegate>)delegate
                     indexPath:(NSIndexPath *)indexPath viewController:(UIViewController *)viewController{
...
- (CustomCell *)dequeueReusableCellAndLoadDataWithAdapter:(CellDataAdapter *)adapter
                                                 delegate:(id <CustomCellDelegate>)delegate
                                                indexPath:(NSIndexPath *)indexPath viewController:(UIViewController *)controller{
    
    CustomCell *cell = [self dequeueReusableCellWithIdentifier:adapter.cellReuseIdentifier forIndexPath:indexPath];
    [cell loadContentWithAdapter:adapter delegate:delegate indexPath:indexPath viewController:controller];
    return cell;
}
